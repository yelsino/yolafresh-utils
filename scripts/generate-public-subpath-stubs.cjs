...
const stubs = [
  ...
  { subpath: "auth", target: "dist/domain/auth/index" },
  { subpath: "auth/contracts", target: "dist/domain/auth/contracts/index" },
  { subpath: "auth/catalogs", target: "dist/domain/auth/catalogs/index" },
  { subpath: "auth/helpers", target: "dist/domain/auth/helpers/index" },
  { subpath: "auth/metadata", target: "dist/domain/auth/metadata/index" },
  { subpath: "auth/version", target: "dist/domain/auth/version/index" },
