import { MedioPagoDigital, MetodoPago } from "../../finanzas/contracts/finanzas.contract";
import { Entidad } from "./entidad.contract";
import { UnidadMedidaEnum } from "../../inventario/contracts/producto.contract";
...
export enum CargosPersonal {
  ...
  VENDEDOR = 'VENDEDOR',
  ANFITRION = 'ANFITRION',
  MOZO_MESERO = 'MOZO_MESERO',
  CAPITAN_SALON = 'CAPITAN_SALON',
  COCINERO = 'COCINERO',
  JEFE_COCINA = 'JEFE_COCINA',
  BARTENDER_ENCARGADO_BARRA = 'BARTENDER_ENCARGADO_BARRA',
