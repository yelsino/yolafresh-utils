...
export enum Permisos {
  ...
  RESTAURANTE_AMBIENTE_VER = "restaurante:ambiente:ver",
  RESTAURANTE_AMBIENTE_CONFIGURAR = "restaurante:ambiente:configurar",
  RESTAURANTE_MESA_VER = "restaurante:mesa:ver",
  RESTAURANTE_MESA_CONFIGURAR = "restaurante:mesa:configurar",
  RESTAURANTE_ESTACION_VER = "restaurante:estacion:ver",
  RESTAURANTE_ESTACION_CONFIGURAR = "restaurante:estacion:configurar",
  RESTAURANTE_CARTA_VER = "restaurante:carta:ver",
  RESTAURANTE_CARTA_CONFIGURAR = "restaurante:carta:configurar",
  RESTAURANTE_SALON_VER = "restaurante:salon:ver",
  RESTAURANTE_SESION_ABRIR = "restaurante:sesion:abrir",
  RESTAURANTE_SESION_ABANDONAR = "restaurante:sesion:abandonar",
  RESTAURANTE_SESION_CERRAR = "restaurante:sesion:cerrar",
  RESTAURANTE_SESION_LIBERAR_INCIDENCIA = "restaurante:sesion:liberar_incidencia",
  RESTAURANTE_PEDIDO_VER = "restaurante:pedido:ver",
  RESTAURANTE_PEDIDO_EDITAR = "restaurante:pedido:editar",
  RESTAURANTE_RONDA_ENVIAR = "restaurante:ronda:enviar",
  RESTAURANTE_ENTREGA_CONFIRMAR = "restaurante:entrega:confirmar",
  RESTAURANTE_PREPARACION_VER = "restaurante:preparacion:ver",
  RESTAURANTE_PREPARACION_ACTUALIZAR = "restaurante:preparacion:actualizar",
  RESTAURANTE_PREPARACION_COCINA_VER = "restaurante:preparacion_cocina:ver",
  RESTAURANTE_PREPARACION_COCINA_ACTUALIZAR = "restaurante:preparacion_cocina:actualizar",
  RESTAURANTE_PREPARACION_BARRA_VER = "restaurante:preparacion_barra:ver",
  RESTAURANTE_PREPARACION_BARRA_ACTUALIZAR = "restaurante:preparacion_barra:actualizar",
  RESTAURANTE_CUENTA_VER = "restaurante:cuenta:ver",
  RESTAURANTE_CUENTA_CONFIGURAR_REDONDEO = "restaurante:cuenta:configurar_redondeo",
  RESTAURANTE_CUENTA_COBRAR = "restaurante:cuenta:cobrar",
