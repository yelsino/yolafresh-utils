...
type UsuarioJSONInput = Omit<
  IUsuario,
  "createdAt" | "updatedAt" | "fechaUltimoAcceso" | "fechaBloqueo"
> & {
  createdAt: Date | string | number;
  updatedAt: Date | string | number;
  fechaUltimoAcceso?: Date | string | number;
  fechaBloqueo?: Date | string | number;
};
...
export class Usuario implements IUsuario {
  ...
  public static fromJSON(data: UsuarioJSONInput): Usuario {
      return new Usuario({
          ...data,
