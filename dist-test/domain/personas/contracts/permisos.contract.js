...
(function (Permisos) {
    ...
    Permisos["RESTAURANTE_AMBIENTE_VER"] = "restaurante:ambiente:ver";
    Permisos["RESTAURANTE_AMBIENTE_CONFIGURAR"] = "restaurante:ambiente:configurar";
    Permisos["RESTAURANTE_MESA_VER"] = "restaurante:mesa:ver";
    Permisos["RESTAURANTE_MESA_CONFIGURAR"] = "restaurante:mesa:configurar";
    Permisos["RESTAURANTE_ESTACION_VER"] = "restaurante:estacion:ver";
    Permisos["RESTAURANTE_ESTACION_CONFIGURAR"] = "restaurante:estacion:configurar";
    Permisos["RESTAURANTE_CARTA_VER"] = "restaurante:carta:ver";
    Permisos["RESTAURANTE_CARTA_CONFIGURAR"] = "restaurante:carta:configurar";
    Permisos["RESTAURANTE_SALON_VER"] = "restaurante:salon:ver";
    Permisos["RESTAURANTE_SESION_ABRIR"] = "restaurante:sesion:abrir";
    Permisos["RESTAURANTE_SESION_ABANDONAR"] = "restaurante:sesion:abandonar";
    Permisos["RESTAURANTE_SESION_CERRAR"] = "restaurante:sesion:cerrar";
    Permisos["RESTAURANTE_SESION_LIBERAR_INCIDENCIA"] = "restaurante:sesion:liberar_incidencia";
    Permisos["RESTAURANTE_PEDIDO_VER"] = "restaurante:pedido:ver";
    Permisos["RESTAURANTE_PEDIDO_EDITAR"] = "restaurante:pedido:editar";
    Permisos["RESTAURANTE_RONDA_ENVIAR"] = "restaurante:ronda:enviar";
    Permisos["RESTAURANTE_ENTREGA_CONFIRMAR"] = "restaurante:entrega:confirmar";
    Permisos["RESTAURANTE_PREPARACION_VER"] = "restaurante:preparacion:ver";
    Permisos["RESTAURANTE_PREPARACION_ACTUALIZAR"] = "restaurante:preparacion:actualizar";
    Permisos["RESTAURANTE_PREPARACION_COCINA_VER"] = "restaurante:preparacion_cocina:ver";
    Permisos["RESTAURANTE_PREPARACION_COCINA_ACTUALIZAR"] = "restaurante:preparacion_cocina:actualizar";
    Permisos["RESTAURANTE_PREPARACION_BARRA_VER"] = "restaurante:preparacion_barra:ver";
    Permisos["RESTAURANTE_PREPARACION_BARRA_ACTUALIZAR"] = "restaurante:preparacion_barra:actualizar";
    Permisos["RESTAURANTE_CUENTA_VER"] = "restaurante:cuenta:ver";
    Permisos["RESTAURANTE_CUENTA_CONFIGURAR_REDONDEO"] = "restaurante:cuenta:configurar_redondeo";
    Permisos["RESTAURANTE_CUENTA_COBRAR"] = "restaurante:cuenta:cobrar";
    // Cuentas y creditos
